...
<body>
	...
	<div class="content">
		<div class="section">
			<div class="container">
				<div class="row">
					<form:form method="POST" action="admin" modelAttribute="usuarioView">
						<div class="col-md-12" role="form">
							<div class="form-group">
								<div class="col-md-6"
									...
									<div class="form-field">
										<form:label path="enabled" style="padding-right: 10px">Habilitado: </form:label>
										<form:checkbox class="form-control" path="enabled" />
										<form:errors path="enabled" cssClass="error-field" />
									</div>
									<div class="form-field">
										<form:label path="userRole" style="padding-right: 10px">Es usuario: </form:label>
										<form:checkbox class="form-control" path="userRole" />
										<form:errors path="userRole" cssClass="error-field" />
									</div>
									<div class="form-field">
										<form:label path="adminRole" style="padding-right: 10px">Es administrador: </form:label>
										<form:checkbox class="form-control" path="adminRole" />
										<form:errors path="adminRole" cssClass="error-field" />
									</div>
								</div>
								<div class="col-md-6"
									style="padding-bottom: 20px; padding-left: 20px;">
